...
# Updated range/default for pMMO high affinity: 1e-5-0.1 mmol/L (safer range)
...
# Dynamic gauge range
max_rate = max(1e-6, V_MMO_final * 2)  # Adjust range based on value
...
- **A_leaf**: 1e-4 m² (Leaf surface area, default)
- **V_leaf**: 2e-7 L (Leaf volume, default)
""")

...
A_V = 1e5 # specific surface area, m^{-1}, typical for plant leaves based on mesophyll surface area to volume ratio
# --- ODE System ---
...
- **A_V**: 100000 m^{-1} (Specific surface area for gas-liquid interface)
""")

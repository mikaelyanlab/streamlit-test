...
V_cell = 1e-15  # L; typical plant cell volume (used for reference, not scaling)
...
# Limit x-axis to 100% (20 points)
x_labels = [f"{i*5}%" for i in range(20)]  # 0% to 95% in 5% increments
if heatmap_matrix.shape[1] > 20:
    heatmap_matrix = heatmap_matrix[:, :20]  # Truncate to 20 points
# Heatmap plot
...
fig_heatmap.update_layout(
    ...
    xaxis=dict(tickmode='array', tickvals=list(range(0, 20, 5)), ticktext=["0%", "25%", "50%", "75%", "100%"])
)
